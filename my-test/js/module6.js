...
//   array
//     .reduce((acc, curr) => [...acc, ...curr.skills], [])
//     .sort((prev, next) => prev.charCodeAt(0) - next.charCodeAt(0));
...
// const getSortedUniqueSkills = array =>
//   array
//     .reduce((acc, obj) => [...acc, ...obj.skills], [])
//     .filter((skill, index, obj) => obj.indexOf(skill) === index)
//     .sort();
